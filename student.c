...
void show_marks(s_info *student){
    ...
    printf("\n\t----------------------------------------------------------------");
    printf("\n\t|     MID MARK       |     FINAL MARK     |     TOTAL MARKS    |");
    printf("\n\t----------------------------------------------------------------");
    int count=0;
    for(int i = 0; i < SUBJECTS_TOTAL; i++){
        printf("\n\t %s",student->result[i].subjects);
        printf("\n\t----------------------------------------------------------------");
        printf("\n\t|        %03d         |         %03d        |         %03d        |",student->result[i].mid_marks,student->result[i].final_marks,(student->result[i].final_marks+student->result[i].mid_marks));
        printf("\n\t---------------------|------------------------------------------");
        if (student->result[i].final_marks + student->result[i].mid_marks< 33)
            count = count + 1;
    }
